<template>
    <PageComponent title="Nurse Manage Patients and Appointments">
            ...
            <DashboardCard class="order-2 lg:order-2 " style="animation-delay: 0.2s">
                ...
                <div class="relative w-full">
                    ...
                    <table class=" divide-y divide-gray-200 w-full">
                        ...
                        <tbody v-for="appointment in appointmentsDataNurse" class="divide-y divide-gray-200">
...
const appointmentsDataNurse = computed(() => store.state.nurseDashboard.appointmentsData);
...
store
    .dispatch("getAppointmentDataNurse", param)
